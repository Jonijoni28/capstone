...
$sql = "SELECT * FROM tbl_cwts WHERE transferred = 0 OR transferred IS NULL ORDER BY last_name ASC";
...
$sql = "SELECT user_info.first_name, registration.username 
        ...
        AND user_info.area_assignment = 'ROTC'";
...
let currentPage = 1;
let rowsPerPage = 50; // Changed to show 10 records per page
